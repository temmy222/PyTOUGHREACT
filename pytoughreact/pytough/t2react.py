        ...
        if self.filename:
            ...
            if (self.type == 'AUTOUGH2'):
                ...
                while running:
                    ...
                    if proper_end is True and running is False:
                        simulation.terminate()
                    elif proper_end is False:
                        break
    ...
    def timestepping_json(self):
        ...
        jsondata['time']['step'] = \
            {'maximum': {'size': self.parameter['max_timestep']},
             'method': 'beuler',
             'solver': {'nonlinear': {'tolerance': {'function': {'absolute': abstol, 'relative': reltol}},
                        'maximum': {'iterations': maxit}}}}
        if self.parameter['max_timesteps'] is not None and self.parameter['max_timesteps'] >= 0:
